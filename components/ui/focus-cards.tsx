...
interface FocusCard {
  ...
  createdAt?: any;
  updatedAt?: any;
  // Add other Project fields if needed to pass through
}
...
interface CardProps {
  ...
  onEdit?: (card: FocusCard) => void;
}

export const Card = React.memo(
  ({ card, index, hovered, setHovered, onEdit }: CardProps) => (
    <div
...
export function FocusCards({ cards, onEdit }: FocusCardsProps) {
